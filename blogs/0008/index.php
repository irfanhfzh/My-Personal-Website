...
<head>
	...
	<title> My new blog 11 - PANHPZH </title>
</head>
<body>
    <!-- Header -->
    <header>
        ...
        <div class="container">
            <div class="parentPost">
                <div class="contentPost">
                    ...
                    <div class="metaTitle">
                        <h1 class="titlePost">My new blog 11</h1>
                        <div id="titleDesc">
                            <p class="date"><i class="fas fa-calendar-alt">  23/12/20, 06:29pm</i></p>
                    ...
                    <hr>
                    <div class="article">
                        dscdqwdcuqgcdiwucqwd<p>cqwdhc8wqgduyqcgwduqc</p>
