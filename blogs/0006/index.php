...
<head>
	...
	<title> My new blog 6 - PANHPZH </title>
</head>
<body>
    <!-- Header -->
    <header>
        ...
        <div class="container">
            <div class="parentPost">
                <div class="contentPost">
                    ...
                    <div class="metaTitle">
                        <h1 class="titlePost">My new blog 6</h1>
                        <div id="titleDesc">
                            <p class="date"><i class="fas fa-calendar-alt">  23/12/20, 05:54pm</i></p>
                    ...
                    <hr>
                    <div class="article">
                        dcqwdciuoqwgdcuqwcdiqw<p>cdqvwcodugqcwudygqwcd<p>qcgwdugcquwdcqwcdqwdcqwdcq</p></p>
