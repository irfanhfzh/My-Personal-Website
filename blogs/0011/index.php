...
<head>
	...
	<title> My new blog 3214132 - PANHPZH </title>
</head>
<body>
    <!-- Header -->
    <header>
        ...
        <div class="container">
            <div class="parentPost">
                <div class="contentPost">
                    ...
                    <div class="metaTitle">
                        <h1 class="titlePost">My new blog 3214132</h1>
                        <div id="titleDesc">
                            <p class="date"><i class="fas fa-calendar-alt">  23/12/20, 09:50pm</i></p>
                    ...
                    <hr>
                    <div class="article">
                        dcqwdcuqwgcduqigwcdbubcqkldcq<p>dcbqwioudcqcwd<p><p>cqwdcbhouiqwcgdhqwcdq</p></p></p>
