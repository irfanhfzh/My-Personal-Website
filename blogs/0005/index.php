...
<head>
	...
	<title> My new blog 55 - PANHPZH </title>
</head>
<body>
    <!-- Header -->
    <header>
        ...
        <div class="container">
            <div class="parentPost">
                <div class="contentPost">
                    ...
                    <div class="metaTitle">
                        <h1 class="titlePost">My new blog 55</h1>
                        <div id="titleDesc">
                            <p class="date"><i class="fas fa-calendar-alt">  23/12/20, 05:46pm</i></p>
                    ...
                    <hr>
                    <div class="article">
                        dcqwdcqwiudgqwcdqw<p>dcqvwydcgqciudqtgcdq<p>cdqcvdi7y6cqfwydcqwsxqwx<p>xdqwucydqfcdwdqd</p></p></p>
